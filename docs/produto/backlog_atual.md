...
| # | Item | Origem | Esf. | Status |
|:-:|---|---|:--:|:--:|
| 17 | **Ligar ações de plano no admin** — ✅ Aprovar (PR#35), ✅ Duplicar (PR#37); faltam: gerar rascunho IA, editar refeições/itens | GAP UX (bloqueia ciclo da nutri) | M | 🟡 2/4 (Aprovar + Duplicar) |
